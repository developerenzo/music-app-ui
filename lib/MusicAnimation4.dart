...
import './MusicAnimation5.dart';
import 'package:adobe_xd/page_link.dart';
import 'dart:ui' as ui;
import 'package:flutter_svg/flutter_svg.dart';

class MusicAnimation4 extends StatelessWidget {
  MusicAnimation4({
    Key key,
  }) : super(key: key);
  @override
          ...
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Padding(
                  padding: EdgeInsets.fromLTRB(0.0, 134.0, 0.0, 0.0),
                  child: Stack(
                    children: <Widget>[
                      Pinned.fromPins(
