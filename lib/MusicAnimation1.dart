...
class MusicAnimation1 extends StatelessWidget {
  MusicAnimation1({
    Key key,
  }) : super(key: key);
  @override
                  ...
                  child: Stack(
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        margin: EdgeInsets.fromLTRB(0.0, 7.0, 1.0, 0.0),
                      ),
                    ],
                  ),
                ),
          ...
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Align(
                  alignment: Alignment(-0.251, 0.016),
                  child: SizedBox(
                    width: 24.0,
                    height: 24.0,
                    child: Stack(
                ...
                Align(
                  alignment: Alignment(0.251, 0.454),
                  child: SizedBox(
                    width: 24.0,
                    height: 24.0,
                    child: Stack(
