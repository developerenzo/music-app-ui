...
class MusicAnimation8 extends StatelessWidget {
  MusicAnimation8({
    Key key,
  }) : super(key: key);
  @override
          ...
          Padding(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Align(
                  alignment: Alignment(-0.595, 0.542),
                  child: SizedBox(
                    width: 10.0,
                    height: 1.0,
                    child: SvgPicture.string(
