    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(0.004, -0.616),
            child: Container(
              width: 138.0,
              height: 67.0,
          ...
          Align(
            alignment: Alignment(0.088, -0.337),
            child: Container(
              width: 239.0,
              height: 67.0,
              color: const Color(0xff000000),
